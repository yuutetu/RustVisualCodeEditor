...
/**
 * Enter / Tab / Shift+Tab キーのインデント処理と、
 * iOS ソフトキーボードの二重発火抑制を担うフック。
 */
export function useEditorKeyHandlers(
  ...
  // iOS では beforeinput で preventDefault() 後も input イベントが発火することがある。
  // handleChange がインデント済みコードを上書きしないよう、フラグで抑制する。
